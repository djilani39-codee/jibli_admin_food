...
class _OrderRemoteDataSource implements OrderRemoteDataSource {
  ...
  Future<HttpResponse<OrderPaginated>> getOrders(
    ...
    final _options = _setStreamType<HttpResponse<OrderPaginated>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late OrderPaginated _value;
    try {
      _value = await compute(deserializeOrderPaginated, _result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<HttpResponse<dynamic>> acceptedOrders(
      {required Map<String, dynamic> queries}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.addAll(queries);
  ...
  @override
  Future<HttpResponse<dynamic>> rejectedOrders(
      {required Map<String, dynamic> queries}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.addAll(queries);
